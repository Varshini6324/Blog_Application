...
export const deleteBtn       = "text-[#0066cc] font-medium hover:text-[#004499] transition-colors cursor-pointer text-sm"
export const editBtn       = "text-[#0066cc] font-medium hover:text-[#004499] transition-colors cursor-pointer text-sm"
...
export const articleStatusActive="text-green "
export const articleStatusDeleted="text-red"

export const  articleActions ="text-red"
export const  articleAuthorRow ="text-red"
export const  articleCategory ="text-red"
export const  articleContent ="text-red"
export const  articleFooter ="text-red"
export const  articleHeader ="text-red"
export const  articleMainTitle ="text-red"
export const  articlePageWrapper ="text-red"
export const  authorInfo ="text-red"